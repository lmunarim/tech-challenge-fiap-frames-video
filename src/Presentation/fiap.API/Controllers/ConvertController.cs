    ...
    public class ConvertController : ControllerBase
    {
        ...
        public async Task<IActionResult> Upload(IFormFile video)
        {
            try
            {
                ...
                var  file  = new FileInfo(@"/app/src/Presentation/fiap.API/fiap.API/lib/ffmpeg/v4/ffmpeg.exe");
                ...
                var ffmpeg = new ProcessStartInfo
                {
                    ...
                    FileName = @"/app/src/Presentation/fiap.API/fiap.API/lib/ffmpeg/v4/ffmpeg.exe",
